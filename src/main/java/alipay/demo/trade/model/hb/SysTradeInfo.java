...
public class SysTradeInfo implements TradeInfo {
    ...
    @SerializedName("STAT")
    private com.alipay.demo.trade.model.hb.HbStatus status;

    private SysTradeInfo() {
        // no public constructor.
    }

    public static SysTradeInfo newInstance(String outTradeNo, double timeConsume, com.alipay.demo.trade.model.hb.HbStatus status) {
    ...
    @Override
    public com.alipay.demo.trade.model.hb.HbStatus getStatus() {
        return status;
    }
